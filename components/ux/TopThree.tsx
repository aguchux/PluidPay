...
const TopThree = ({
  ...
  return (
    <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-3">
      <div className="mb-2 text-xs font-semibold uppercase text-emerald-800">Top 3 by Received</div>
      <div className="flex flex-wrap gap-2">
        {top.map((r) => (
          <div
            key={r.providerId}
            className="flex items-center gap-2 rounded-lg bg-white px-3 py-2 shadow-sm ring-1 ring-emerald-100"
          >
            {r.logoSrc ? (
